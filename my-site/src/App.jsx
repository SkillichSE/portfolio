...
export default function Portfolio() {
  ...
  useEffect(() => {
    ...
    // Пути к картинкам (все должны быть в public)
    const imagePaths = [
      "blackwhite.png",
      "blackpurple.png",
      "BRAZILAVA.png",
    ...
    const objectSize = 40; // фиксированный размер всех объектов
    const objects = Array.from({ length: 50 }, () => ({
      x: Math.random() * window.innerWidth,
      y: Math.random() * window.innerHeight,
      s: Math.random() * 0.5 + 0.2, // медленная скорость
      size: objectSize,
      img: images[Math.floor(Math.random() * images.length)],
      rotation: Math.random() * Math.PI * 2,
      rotationSpeed: (Math.random() - 0.5) * 0.02, // лёгкое вращение
    }));
    ...
    // Запускаем анимацию, когда все картинки загрузятся
      ...
      >
        ...
        >
          <div style={cardStyle}>
            ...
            <a
              href="https://discordapp.com/users/1101053298351538236"
              target="_blank"
              rel="noreferrer"
              style={buttonStyle}
            >
          ...
          <div style={cardStyle}>
            ...
            <a href="https://t.me/Skillich" target="_blank" rel="noreferrer" style={buttonStyle}>
              @Skillich
            </a>
          </div>
          ...
          <div style={cardStyle}>
            ...
            <a href="https://github.com/SkillichSE" target="_blank" rel="noreferrer" style={buttonStyle}>
              github.com/SkillichSE
            </a>
          </div>
        </div>
